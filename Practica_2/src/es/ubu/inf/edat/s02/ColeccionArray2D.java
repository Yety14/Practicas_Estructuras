...
public class ColeccionArray2D<E> extends AbstractCollection<E> {
	...
	public E set (int posici�n, E dato) {
		// TODO Completar el metodo para modificar el contenido de una posici�n del array 2D
	}
	...
	private class Iterator2D implements Iterator<E> {
		...
		public boolean hasNext() {
			// TODO Completar el código del iterador
		}
