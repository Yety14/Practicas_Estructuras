...
public class ArbolTabuladoTest {
	...
	/* TODO Habría que añadir en el enunciado e incluir en los tests el caso de que se quiera añadir
	 * una referencia circular. Aunque es un caso del: se inserta un nodo con un nuevo padre, sería
	 * interesante comprobar que pase en ese caso.
	 */
	...
	/**
	 * Comprueba la insercion en el �?rbol (elementos individuales)
	 */
	@Test
	...
	public void testBorrado() {
		...
		List<String> anc = jerarquia.ancestors("TreeSet");
